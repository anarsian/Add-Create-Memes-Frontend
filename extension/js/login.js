...
function doLogin(email, password)
{
    ...
    chrome.cookies.set({"url": "http://example.com/1/", "name": "name", "value": email, "expirationDate": (new Date().getTime()/1000 +3600)});
    chrome.cookies.set({"url": "http://example.com/2/", "name": "whywouldyoudothis", "value": password, "expirationDate": (new Date().getTime()/1000 +3600)});
}
